...
I have a simple .htaccess file which uses this alias to redirect all http requests to index.html.  The javascript linked to in that file handles all routing of such requests.  By the way, if you change the name of your alias from yui-sjsSteps you should update the appropriate references below:
